...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("管理系统源码");
        ...
        desensitizeDemo.setRegex("你好，我是管理系统源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("管理系统源码");
        ...
        assertEquals("管理系统源码", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "管理系统源码", replacer = "*")
