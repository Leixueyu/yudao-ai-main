...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "管理系统源码")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "管理系统")
        private Long id;
